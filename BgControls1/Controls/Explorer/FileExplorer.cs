...
/// </summary>
[TemplatePart(Name = FileExplorer.PartDrivesTree, Type = typeof(TreeView))]
[TemplatePart(Name = FileExplorer.PartItemsList, Type = typeof(ListView))]
public class FileExplorer : Control
{
    ...
    private string ThisComputerText => Ioc.Instance.GetString("此电脑");

    private string DriverText => Ioc.Instance.GetString("驱动器");

    private string FolderText => Ioc.Instance.GetString("文件夹");

    private string FileText => Ioc.Instance.GetString("文件");
    ...
    private object CreateHeader(string text, ImageSource? iconSource)
    {
        ...
        _ = stackPanel.Children.Add(new System.Windows.Controls.Image { Source = iconSource, Width = 16, Height = 16, Margin = new Thickness(0, 0, 5, 0) });
    ...
    private static class IconManager
    {
        ...
        /// </summary>
        private static ImageSource? GetIconFromKnownFolder(Guid knownFolderId)
        {
            // 步骤1: 获取指向已知文件夹的 PIDL
