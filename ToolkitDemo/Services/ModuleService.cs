...
internal class ModuleService : ModuleServiceBase
{
    ...
    public override Task<bool> InitializeAsync()
    {
        ...
        this.Modules.Clear();
        this.Modules.Add(new ModuleInfo(UserAuthority.Operator, 1, "首页", typeof(Views.ModuleHostView).AssemblyQualifiedName, true, 0));
        this.Modules.Add(new ModuleInfo(UserAuthority.Engineer, 2, "文件管理", typeof(Views.ModuleHostView).AssemblyQualifiedName, true, 0));
        this.Modules.Add(new ModuleInfo(UserAuthority.Engineer, 3, "视觉编辑", typeof(Views.ModuleHostView).AssemblyQualifiedName, true, 0));
        this.Modules.Add(new ModuleInfo(UserAuthority.Engineer, 4, "CAD编辑", typeof(Views.ModuleHostView).AssemblyQualifiedName, true, 0));
