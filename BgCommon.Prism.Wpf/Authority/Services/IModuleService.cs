...
public interface IModuleService
{
    ...
    Task<ResponseResult<List<Entities.ModuleInfo>>> GetAllSystemModulesAsync(UserInfo operatorUser);
    ...
    Task<ResponseResult<ModuleInfo>> AddModuleAsync(Entities.ModuleInfo moduleToAdd, UserInfo operatorUser);
    ...
    /// <param name="operatorUser">执行此操作的用户.</param>
    /// <returns>操作结果.</returns>
    Task<ResponseResult<ModuleInfo>> UpdateModuleAsync(Entities.ModuleInfo moduleToUpdate, UserInfo operatorUser);
    ...
    Task<ResponseResult<List<Entities.ModuleInfo>>> GetAuthorizedModulesAsync(UserInfo? operatorUser, long? parentId = null);
    ...
    /// <param name="parentId">父模块ID.</param>
    /// <returns>子模块列表.</returns>
    Task<ResponseResult<List<Entities.ModuleInfo>>> GetModulesAsync(UserInfo operatorUser, long? parentId = null);
}